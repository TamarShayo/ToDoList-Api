...
namespace OrderManagement
{
    static class Extention
    {
        ...
        {
            services.AddScoped<ToDoList.Interfaces.ITaskService, ToDoList.Services.TaskService>();
            services.AddScoped<ToDoList.Interfaces.IUserService, ToDoList.Services.UserService>();
            return services;
        }
    }
}
